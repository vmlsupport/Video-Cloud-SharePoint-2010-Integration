<%@ Register TagPrefix="WpNs1" Namespace="BrightcoveVideoCloudIntegration.VideoPicklist" Assembly="BrightcoveVideoCloudIntegration, Version=1.0.0.0, Culture=neutral, PublicKeyToken=6a792aa6dfad51a4"%>
<%@ Register TagPrefix="WpNs0" Namespace="BrightcoveVideoCloudIntegration.VideoPlaylist" Assembly="BrightcoveVideoCloudIntegration, Version=1.0.0.0, Culture=neutral, PublicKeyToken=6a792aa6dfad51a4"%>
...
<div id="contentContainer">
	<div id="contentDiv">
		<div id="top"><div id="logo"><a href="http://www.brightcove.com/"><img src="images/brightcove-0.jpg" border="0" /></a></div><div class="title">Sharepoint Integration: <span class="pgName">Video Playlist</span></div></div>
