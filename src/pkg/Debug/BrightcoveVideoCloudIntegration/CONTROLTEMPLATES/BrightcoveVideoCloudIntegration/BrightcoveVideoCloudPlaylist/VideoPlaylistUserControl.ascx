...
function InitVideoPlaylist() {
    ...
    $('.playlistRow').each(function (index) {
        ...
        pThumb.css({ 'max-height':'48px', 'float':'left', 'vertical-align':'text-top', 'margin-right':'5px' });
    ...
    // Handle click playlist name
    $('.playlistRow .playlist a').each(function () {
        $(this).attr("href", vcPlayVideoLink.replace(/\{0\}/, $(this).parent().parent().find('.playlistId').attr('val')));
    });
}
...
function CopyBlogCode(pid) {
    var playerId = '981269426001';
    var opid = 'player_981269426001_' + Math.floor(100000000 * Math.random());
    var width = '960';
    var height = '450';
    var bgColor = 'FFFFFF';
    var blog =
		...
		'    <param name="Movie" value="https://secure.brightcove.com/services/viewer/federated_f9?&amp;width=' +
            width + '&amp;height=' + height + '&amp;flashID=player_981269426001_undefined&amp;playerID=' + playerId + '&amp;%40playlistTabs=' +
            pid + '&amp;%40playlistTabs.featured=' + pid + '&amp;%40videoList.featured=' + pid + '&amp;dynamicStreaming=true&amp;cacheAMFURL=http%3A%2F%2Fshare.brightcove.com%2Fservices%2Fmessagebroker%2Famf&amp;secureConnections=true&amp;bgcolor=%23' + 
		...
		'    <embed src="http://c.brightcove.com/services/viewer/federated_f9?isVid=1&isUI=1" bgcolor="#' + bgColor + '" flashVars="@40playlistTabs=' +
            pid + '&@playlistTabs.featured=' + pid + '&playerID=' + playerId + '&@videoList.featured=' + pid + '&playerKey=AQ~~,AAAA5HYg_Wk~,dVrb4Dhl3iu-bD2b6KPfevAEl_qyND1e&domain=embed&dynamicStreaming=true" base="http://admin.brightcove.com" name="flashObj" width="' + 
...
<div class="playlistControls">
    <div class="newPlaylist" style="display:none;">
        ...
        <div class="ctrlTags" style="display:none;">
